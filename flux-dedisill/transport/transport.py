...
class Transport:
    ...
    def training_losses(self, model, x1, model_ref=None, model_kwargs=None, extra_kwargs=None, controlnet=None, controlnet_kwargs=None):
        ...
        if extra_kwargs is not None:
            ...
            with th.no_grad():
                model_kwargs["guidance"] = cfg_scale
