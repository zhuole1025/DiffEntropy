...
def main(args, rank, master_port):
    ...
    if args.debug == False:
        ...
        if not os.path.exists(ckpt_path):
            ckpt_path = "/data/zl/DiffEntropy/flux/results/1024_1.0_256_1.0_depth_2_4_19_38_snr_uniform_none_cfg_1.0_1.0_wo_shift_lr_1e-5_cap_redux_tiled_multi_degradation_wo_noise/checkpoints/0004000/consolidated.00-of-01.pth"
