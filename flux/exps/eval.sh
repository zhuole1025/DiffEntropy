...
double_gate=1.0
single_gate=1.0
model_dir=/data/zl/DiffEntropy/flux/results/1024_1.0_256_1.0_depth_2_4_19_38_snr_lognorm_none_cfg_1.0_1.0_bsz_256_wo_shift_lr_1e-5_cap_redux_only_tiled_multi_degradation_wo_noise_wo_usm/checkpoints/${train_steps}
cap_dir=/data/zl/datasets/RealLQ250/lq
out_dir=samples/eval/lq250_v3_with_single_control_redux_tiled_multi_degradation_train_wo_noise_wo_usm_${train_steps}_gate_${double_gate}_${single_gate}_cfg_${backbone_cfg}_${controlnet_cfg}_image_prompt_bsz256_lognorm
