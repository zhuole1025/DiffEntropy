...
out_dir=samples/v3_with_single_control_redux_tiled_multi_degradation_train_wo_noise_wo_usm_bsz_256_${train_steps}_gate_${double_gate}_${single_gate}_cfg_${backbone_cfg}_${controlnet_cfg}_image_prompt_lognorm
