...
class DiscriminatorHead(nn.Module):
    def __init__(self, in_channels: int, out_channels: int = 1):
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(kernel_size=1, in_channels=in_channels, out_channels=in_channels, stride=1, padding=0),
        ...
        # self.conv1 = nn.Sequential(
        #     nn.Conv2d(kernel_size=4, in_channels=in_channels, out_channels=in_channels, stride=2, padding=1), # 32x32 -> 16x16 
        #     nn.GroupNorm(num_groups=32, num_channels=in_channels),
        #     nn.SiLU(),
        # )
        # self.conv2 = nn.Sequential(
        #     nn.Conv2d(kernel_size=4, in_channels=in_channels, out_channels=in_channels, stride=2, padding=1), # 16x16 -> 8x8 
        #     nn.GroupNorm(num_groups=32, num_channels=in_channels),
        #     nn.SiLU(),
        # )
        # self.conv3 = nn.Sequential(
        #     nn.Conv2d(kernel_size=4, in_channels=in_channels, out_channels=in_channels, stride=2, padding=1), # 8x8 -> 4x4
        #     nn.GroupNorm(num_groups=32, num_channels=in_channels),
        #     nn.SiLU(),
        # )
        # self.conv4 = nn.Sequential(
        #     nn.Conv2d(kernel_size=4, in_channels=in_channels, out_channels=in_channels, stride=4, padding=0), # 4x4 -> 1x1
        #     nn.GroupNorm(num_groups=32, num_channels=in_channels),
        #     nn.SiLU(),
        # )
        self.conv_out = nn.Conv2d(kernel_size=1, in_channels=in_channels, out_channels=out_channels, stride=1, padding=0) # 1x1 -> 1x1
