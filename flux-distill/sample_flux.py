        ...
        for idx, item in tqdm(enumerate(data)):
            ...
            for high_res in args.resolution:
                for guidance in args.guidance_list:
                    ...
                    sample_id = f'{idx}_{high_res}_{guidance}'
                    ...
                    model_kwargs = dict(
                        ...
                        guidance=torch.full((x.shape[0],), guidance, device=x.device, dtype=x.dtype), 
                        txt_cfg_scale=0.0, 
                    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--guidance_list", type=str, default='4.0')
    ...
    args.guidance_list = [float(guidance) for guidance in args.guidance_list.split(',')]
